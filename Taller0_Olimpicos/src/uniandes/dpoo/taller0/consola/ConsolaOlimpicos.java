...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le informa al usuario el pa�s al que pertenece un atleta
	 */
	...
	private void ejecutarPorcentajeMedallistas()
	{
		...
		String nacion = calculadora.buscarAtleta(nombreAtleta).darPais().darNombre();
		System.out.println("El pa�s del atleta es: " +nacion);
	}
